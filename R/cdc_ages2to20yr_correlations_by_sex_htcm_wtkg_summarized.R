...
#' 
#' The mean correlations over the 10x replicates of optimization is calculated for use in the SimKid package.
...
#'   \item{NITER}{Number of iterations (i.e., replicates) that contributes to the MEAN_HTWT_COR calculation}
#'   \item{NSUBJ_AGEMO_SEXF}{Number of virtual subjects, in each replicate of the optimization procedure, per month of age and per sex that contributes to the MEAN_HTWT_COR calculation}
#'   \item{MEAN_HTWT_COR}{Mean across the replicates of optimized correlation between z-score of weight and z-score of height}
#' }
#' @source data-raw/cdc_ages2to20yr_correlations_by_sex_htcm_wtkg_allreplicates.csv
