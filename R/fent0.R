...
#' 
#' Fenton growth charts for male and female weight vs. age were digitized up to 40 weeks (for full-term) from the literature (1-3) using PinPoint Digitizer (4).
...
#'   \item{AGEGRP}{Newborn age group bucket in weeks (PNA is postnatal age; GA is gestational age)}
